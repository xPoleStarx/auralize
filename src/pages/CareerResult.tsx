...
import { careerQuizQuestions } from '../pages/Quiz'; // Kariyer sorularını import et
    ...
    const generateCareerAnalysis = async () => {
      ...
      try {
        ...
        const detailedAnswers = Object.entries(state.answers).map(([questionId, answerId]) => {
          // CareerQuizQuestions dizisinden ilgili soruyu bul
          const question = careerQuizQuestions.find((q: QuizQuestion) => q.id === parseInt(questionId));
